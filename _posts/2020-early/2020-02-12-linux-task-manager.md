...
![image-20200212202516163](https://image.tobyqin.cn/image-20200212202516163.png)
...
![image-20200212204136480](https://image.tobyqin.cn/image-20200212204136480.png)

## 如果要杀掉某些任务怎么办？

直接按`k`就好了，首先会让你输入`PID`，然后再输入`SIG`，回车搞定。

![image-20200212210832677](https://image.tobyqin.cn/image-20200212210832677.png)
...
![image-20200212211906608](https://image.tobyqin.cn/image-20200212211906608.png)
